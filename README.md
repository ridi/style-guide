...
- 타협하지 말 것
- 필요하다면 다른 수단을 사용하여 토론하되, 해결책은 기록을 남길 것
- 상대의 시간이 낭비되지 않도록 배려할 것
  - 요청자는 리뷰어가 이해할 수 있도록 코드의 작성 배경, 의도된 동작, 테스트 방법 등을 충분히 설명할 것
  - 리뷰어는 요청자가 오래 기다리지 않도록 빠르게 리뷰를 완료하거나 리뷰 가능 시기를 전달할 것
